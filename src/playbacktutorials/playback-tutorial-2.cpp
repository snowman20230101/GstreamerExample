...
int play_back_tutorial_2_main(int argc, char *argv[]) {
    ...
    /* Set the URI to play */
    g_object_set(data.playbin, "uri", "file:///home/wuwenbin/sintel_trailer-480p.ogv", NULL);

    /* Set the subtitle URI to play and some font description */
    g_object_set(data.playbin, "suburi", "file:///home/wuwenbin/sintel_trailer_gr.srt", NULL);
    ...
    gst_bus_add_watch(bus, (GstBusFunc) play_back_2_handle_message, &data);
...
#endif
    g_io_add_watch(io_stdin, G_IO_IN, (GIOFunc) play_back_2_handle_keyboard, &data);
...
static void analyze_streams(custom_data_play_back_2 *data) {
    gint i;
    GstTagList *tags;
    gchar *str;
    guint rate;
