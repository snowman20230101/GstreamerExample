...
static void send_seek_event(custom_data_13 *data) {
    gint64 position;
    GstEvent *seek_event;
...
static gboolean handle_keyboard(GIOChannel *source, GIOCondition cond, custom_data_13 *data) {
    gchar *str = nullptr;

    if (g_io_channel_read_line(source, &str, nullptr, nullptr,
